...
import 'package:mahmoud/screans/lab/register_lab.dart';

import 'package:mahmoud/screans/test_screen.dart';
import 'package:mahmoud/shared/snakbar.dart';

class loginScreenLab extends StatefulWidget {
  @override
  _loginScreenLab createState() => _loginScreenLab();
}

class _loginScreenLab extends State<loginScreenLab> {
  bool isVisable = true;
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RegisterScreenLab(),
                          ),
                        );
                      },
                      child: Text(
