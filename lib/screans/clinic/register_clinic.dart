...
class RegisterScreenClinic extends StatefulWidget {
  RegisterScreenClinic({super.key});

  @override
  State<RegisterScreenClinic> createState() => _RegisterScreenClinicState();
}

class _RegisterScreenClinicState extends State<RegisterScreenClinic> {
  ...
  register() async {
    try {
      ...
      final storageRef = FirebaseStorage.instance.ref("ClinicsUser/$imgName");
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate() &&
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => loginScreenClinic(),
                            ),
                          );
                        } else {
