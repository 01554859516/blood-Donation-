...
import 'package:mahmoud/screans/clinic/register_clinic.dart';
import 'package:mahmoud/screans/test_screen.dart';

import 'package:mahmoud/shared/snakbar.dart';

class loginScreenClinic extends StatefulWidget {
  @override
  _loginScreenClinic createState() => _loginScreenClinic();
}

class _loginScreenClinic extends State<loginScreenClinic> {
  bool isVisable = true;
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RegisterScreenClinic(),
                          ),
                        );
                      },
                      child: Text(
